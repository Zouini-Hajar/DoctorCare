...
import useGetProfil from '../../hooks/useFetchData'
...
const MyAccount = () => {
  ...
  const {data:userData , loading , error} = useGetProfil(`${BASE_URL}/users/profile/me`)
      ...
      <div className="max-w-[1170px] px-5 mx-auto">
        ...
        {!loading && !error && (
          ...
          <div className="md:col-span-2 md:px-[30px]">
            ...
            {tab === "settings" && <Profil userData={userData} />}
          </div>
        </div>
        )}
      </div>
